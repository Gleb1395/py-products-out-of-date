...
def test_check_first_outdated_product(data_groceries: list) -> None:
    result = outdated_products(data_groceries)
    assert result == ["salmon", "chicken", "duck"]


def test_check_empty_groceries() -> None:
    result = outdated_products([])
    assert result == []


def test_check_valid_groceries(data_groceries: list) -> None:
...
def test_check_invalid_expiration_date(data_groceries: list) -> None:
...
def test_check_expiration_date_equals_yesterday(data_groceries: list) -> None:
